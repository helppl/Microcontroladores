...
/*   *******************************************************************************
  ...
  if (status == MI_OK)
  {
    ...
    if (serNum[0] == 0xBB && serNum[1] == 0x01 && serNum[2] == 0xB5 && serNum[3] == 0xA9 && serNum[4] == 0xA6 && ENTRADA1 == 0) // Entrando pela primeira vez 
       {
       Entrada1();
       lcd.setCursor( 3 , 0 );
     ...
     else if (serNum[0] == 0xBB && serNum[1] == 0x01 && serNum[2] == 0xB5 && serNum[3] == 0xA9 && serNum[4] == 0xA6 && ENTRADA1 == 1) //Saindo do local 
       {
       Saida1();
       lcd.setCursor( 2 , 0 );
      ...
      else if (serNum[0] == 253 && serNum[1] == 125 && serNum[2] == 181 && serNum[3] == 21 && serNum[4] == 32 && ENTRADA2 == 0) //Entrando pela primeira vez 
       {
       Entrada2();
       lcd.setCursor( 3, 0 );
       lcd.print("BEM VINDO,"); // printar a msg de acesso 
     ...
     else if (serNum[0] == 253 && serNum[1] == 125 && serNum[2] == 181 && serNum[3] == 21 && serNum[4] == 32 && ENTRADA2 == 1) //Entrando pela primeira vez 
       {
       Saida2(); 
       lcd.setCursor( 2, 0 );
       lcd.print("VOLTE SEMPRE,"); // printar a msg de acesso 
 ...
 int Entrada1(void){
       ...
       Serial.print(" SR. FELICIO!"); // printar na parte de baixo do display
       
       return 0;
 } 
  int Entrada2(void){
       Serial.print("BEM VINDO,"); // printar a msg de acesso 
       Serial.print(" SR. BAPTISTA!"); // printar na parte de baixo do display
